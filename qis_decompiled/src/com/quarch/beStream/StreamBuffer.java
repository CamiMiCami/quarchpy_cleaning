...
public class StreamBuffer {
    ...
    private int[] resampleData(boolean trigger, int[] stripe) {
        int[] resampledStripe = null;
        this.resampleTrigger |= trigger;
    ...
    public void add(boolean trigger, int[] stripe) {
        if (this.isResampleActive) {
            boolean stripeTrigger = this.resampleTrigger;
            stripe = this.resampleData(trigger, stripe);
        }
